...
<!--
	Export doctor accounts
	URL: {$root}/export/[username]/doctor-accounts
	...
	Export all doctor accounts associated with the current user
-->
<xsl:template match="/data">
	<xsl:copy-of select="export-doctor-accounts"/>
</xsl:template>
</xsl:stylesheet>