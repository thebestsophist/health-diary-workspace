<?php
	...
	Class eventfood extends SectionEvent{

		public $ROOTELEMENT = 'food';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2013-07-25T23:11:27+00:00',
				'trigger-condition' => 'action[food]'
			);
		}
        ...
        <pre class="XML"><code>&lt;food result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/food></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;food result="error">
...
&lt;/food></code></pre>
  ...
  &lt;/label>
  &lt;label>Eaters
    &lt;select name="fields[eaters][]" multiple="multiple">
  ...
  &lt;/label>
  &lt;label>Proteins
    &lt;input name="fields[proteins]" type="text" />
  &lt;/label>
  &lt;label>Spices and Flavorings
    &lt;input name="fields[spices]" type="text" />
  &lt;/label>
  &lt;label>Ingredients
    &lt;input name="fields[ingredients]" type="text" />
  &lt;/label>
  &lt;label>Comment
...
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['food'])) return $this->__trigger();
		}
