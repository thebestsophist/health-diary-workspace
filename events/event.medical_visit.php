<?php
	...
	Class eventmedical_visit extends SectionEvent{

		public $ROOTELEMENT = 'medical-visit';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2013-07-25T23:11:30+00:00',
				'trigger-condition' => 'action[medical-visit]'
			);
		}
        ...
        <pre class="XML"><code>&lt;medical-visit result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/medical-visit></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;medical-visit result="error">
...
&lt;/medical-visit></code></pre>
  ...
  &lt;label>Day Scheduled
    &lt;input name="fields[day-scheduled][start][]" type="text" />
    &lt;input name="fields[day-scheduled][end][]" type="text" />
  &lt;/label>
  ...
  &lt;/label>
  &lt;label>Visit Time
    &lt;input name="fields[visit-time][start][]" type="text" />
    &lt;input name="fields[visit-time][end][]" type="text" />
  &lt;/label>
  &lt;input name="fields[doctor]" type="hidden" value="..." />
  &lt;label>Rating
    &lt;select name="fields[rating]">
...
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['medical-visit'])) return $this->__trigger();
		}
