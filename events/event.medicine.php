<?php
	...
	Class eventmedicine extends SectionEvent{

		public $ROOTELEMENT = 'medicine';
		...
		public static function about(){
			return array(
				...
				'release-date' => '2013-07-25T23:11:38+00:00',
				'trigger-condition' => 'action[medicine]'
			);
		}
        ...
        <pre class="XML"><code>&lt;medicine result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/medicine></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;medicine result="error">
...
&lt;/medicine></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[medicine]" type="submit" value="Submit" />
&lt;/form></code></pre>
		...
		public function load(){
			if(isset($_POST['action']['medicine'])) return $this->__trigger();
		}
